...
export class IdentityApiService {
  ...
  authorizeDocumentScanner(scannerAuthorization: string | undefined, correlationId: string) {
    if (!scannerAuthorization) {
      throw new DomainProblem(401, 'WORKLOAD_AUTHENTICATION_REQUIRED', 'Document scanner authentication is required');
    }
    return this.translate(this.client.authorizeDocumentScanner(scannerAuthorization, correlationId));
  }
