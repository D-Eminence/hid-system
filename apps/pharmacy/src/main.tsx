...
import { useConnectivity, registerScopedServiceWorker } from '@hid/offline'
...
initializeTelemetry({
  app: 'pharmacy', environment: import.meta.env.MODE,
...
function Root() {
  ...
  return <ApplicationErrorBoundary app="pharmacy"><OfflineBanner offline={offline} /><App /></ApplicationErrorBoundary>
}
