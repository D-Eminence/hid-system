...
initializeTelemetry({
  app: 'lab', environment: import.meta.env.MODE, release: import.meta.env.VITE_HID_RELEASE,
...
function Root() {
  ...
  return <ApplicationErrorBoundary app="lab"><OfflineBanner offline={offline} /><App /></ApplicationErrorBoundary>
}
